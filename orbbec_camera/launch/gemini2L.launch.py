...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument("connection_delay", default_value="200"),
        ...
        DeclareLaunchArgument("ir_gain", default_value="15000"),
        DeclareLaunchArgument("ir_brightness", default_value="550000"),
        ...
        DeclareLaunchArgument('enable_disparity_to_depth', default_value='false'),
        ...
        DeclareLaunchArgument("depth_work_mode", default_value="In-scene Calibration"),
        ...
        DeclareLaunchArgument("enable_depth_scale", default_value="false"),
        DeclareLaunchArgument("retry_on_usb3_detection_failure", default_value="false"),
        DeclareLaunchArgument("enable_heartbeat", default_value="false"),
        DeclareLaunchArgument("enable_firmware_log", default_value="false"),
        DeclareLaunchArgument("enable_noise_removal_filter", default_value="false"),
        DeclareLaunchArgument("interleave_ae_mode", default_value="laser"),
        #DeclareLaunchArgument("interleave_frame_enable", default_value="false"),
        DeclareLaunchArgument("hdr_index1_ir_brightness", default_value="1000"),
        DeclareLaunchArgument("hdr_index0_ir_brightness", default_value="1000"),
        DeclareLaunchArgument("hdr_index1_ir_ae_max_exposure", default_value="50458"),
        DeclareLaunchArgument("hdr_index0_ir_ae_max_exposure", default_value="50458"),
        DeclareLaunchArgument("laser_index1_ir_brightness", default_value="120"),
        DeclareLaunchArgument("laser_index0_ir_brightness", default_value="120"),
        DeclareLaunchArgument("laser_index1_ir_ae_max_exposure", default_value="20000"),
        DeclareLaunchArgument("laser_index0_ir_ae_max_exposure", default_value="20000"),
        DeclareLaunchArgument("hdr_index1_laser_control", default_value="0"),
        DeclareLaunchArgument("hdr_index0_laser_control", default_value="0"),
