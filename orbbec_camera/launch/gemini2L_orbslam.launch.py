...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument("color_width", default_value="800"),
        DeclareLaunchArgument("color_height", default_value="600"),
        ...
        DeclareLaunchArgument("ir_exposure", default_value="5000"),
        DeclareLaunchArgument("ir_gain", default_value="3500"),
        DeclareLaunchArgument("ir_brightness", default_value="1050"),
        ...
        #DeclareLaunchArgument("time_sync_period", default_value="2.0"),
